...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "microservice2@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "microservice2 API";

        private String description = "microservice2 API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "microservice2";
